#kmeans
data = read.csv("C:\\Users\\redbe\\OneDrive\\Documents\\BeVera\\Exercise_Spend.csv")
head(data)
...
box$stats
#column 2 contains the boxplot stats for Annual_Income.
#calculate quantiles and explore
